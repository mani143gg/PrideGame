...
function create ()
{
    ...
    const buttonTxt = this.add.text(145,441,'start',{fontFamily: 'Cloudsters', color: '#ffffff',fontSize: '14px',lineHeight: 22,textAlign: 'center'});
   
    
//   heading text
    const text = this.add.text(75,10, "TRIBE PRide", { fontFamily: "Afolkalips", fontSize: 70 });
...
//   subhead text
    const text2 = this.add.text(65,80, "PLAY TO WIN EXCITING PRIZES",{fontFamily: 'CircularStd, sans serif',fontSize: 14,color: '#a07729',fontWeight: 500,textAlign:'center',display:'block',margin:'0 auto'});
